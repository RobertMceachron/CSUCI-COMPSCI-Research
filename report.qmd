...
graduation from 1987 to 2018.  Overall, the study found that all demographic groups had lower levels of graduation compared to enrollment.  Graduation rates of white women declined sharply after 1990, graduation rates of Black women sharply declined after 1995, graduation rates of Asian women steadily declined after 1999, Hispanic women consistently represented less than 2% of the population of computing graduates, and there were many years where Native American women did not graduate from computing programs at all.  White men represented the largest demographic of computing graduates (between 45.2% and 71.8% of the total population of computing graduates), followed by Asian men at around 10%.  Graduation rates for Black men remained below 5% from 2005 onward, and graduation rates of Hispanic men were consistently less than 6%.  There were many years where Native American men had no graduates from computing degrees.  Historical context analysis revealed more about the responses to declines in minority enrollment and graduation, rather than what actually caused those declines.  There was much discussion about the creation of professional organizations and conferences dedicated to fostering a sense of belonging among minority women in computing.
...
Due to the type and amount of data collected, the present research had numerous limitations. First, it was unclear why students did not graduate. Students’ reasons for dropping out were not collected, and we were subsequently unable to determine whether they transferred to another institution or simply took a break from their education. Second, the historical impact of COVID-19 could not be fully analyzed due to students who began their degree during or after this time still being enrolled. It is theorized that COVID-19 likely had a significant impact on graduation rates, and due to half of our data being collected after this historical event, it could explain a lot regarding graduation. Third, the extreme outliers in variables such as tutoring visits and unit load required binning, as these students did not represent the overall population. This likely resulted in a loss of information, which could have helped explain more of the variance in graduation. Lastly, variables such as GPA, classes taken each semester, and income level could have helped explain graduation. The variables were not included due to the sensitive nature of institutional data, but institutional researchers could further examine their effects. The limitations mentioned above limit the explanatory power and generalizability of our analyses, but future research can account for some of these variables. 

Future research should compare graduation rates across departments to determine whether the significant predictors are specific to the Computer Science Department. Furthermore, examining parental and student income status could provide valuable insight into why students drop out. Statistical analyses such as Discrete-time Survival Analysis could help explain when students drop out of the program, as the Cox Proportional Hazards model run in the current research did not meet its assumptions. Lastly, Qualitative interviews could prove beneficial for identifying the stressors students have personally identified in the Computer Science Department and for validating or expanding the variables of interest. 
