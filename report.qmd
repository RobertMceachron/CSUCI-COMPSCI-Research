...
-   [Exploration of Intersectionality and Computer Science
    Demographics](https://dl-acm-org.ezproxy.csuci.edu/doi/abs/10.1145/3445985)

    -   Used intersectional lens to analyze data from the
        Multiple-Institution Database about CS graduation rates by
        demographic
    -   MIDFIELD database: longitudinal with student data from 19
        different institutions and over 1.5 million undergraduates'
        demographic information and transcript data
        -   Looked at grad rates from 1987--2018
        -   Subset dataset to only include CS, Computer Programming, IT,
            and Information Science
            -   43000 students over 1987--2018
    -   Quantitative analysis using Python 3.7.4, Pandas and NumPy
        -   All demographics were calculated annually for both
            enrollment and graduation as percentages of each group
            across institutions, relative to the total population of
            students in computing that year
    -   Historical context analysis: institutional funding, initatives,
        organizations, or groups that could impact academic decisions
        -   Included creation of demographic-specific groups in
            computing to foster a sense of belonging
        -   "Shift": increase/decrease of intersectional population over
            the span of a single year, or several years OR periods of
            volatility relative to demographics of more stable counts
            (for populations with TINY enrollment)
        -   Identify shift --\> search for relevant historical event on
            Google Scholar
    -   Results:
        -   White women have the highest enrollments relative to other
            racial/ethnic backgrounds, but only accounted for 19.7% of
            the total computing population at its highest, continuing to
            diminish until 2018 (7.6%)
        -   Black women had the highest enrollment of any racial/ethnic
            group in 1991 at 14.3% of the total computing population,
            but then diminished to 0.7% by 2018
        -   Asian women started enrollment in 1987 at 0.7%, but
            increased to 4.0% by 2018
        -   Native American women reach their highest representation
            levels at 0.8% in 2007, but otherwise rarely reach 0.5% and
            are sometimes 0.0%
        -   Hispanic/Latinx women peaked at 2.0% in 2002
        -   

-   [Multi-Institution Study of Student Demographics and Outcomes in
    EE/CE](https://ieeexplore-ieee-org.ezproxy.csuci.edu/document/6881755)

-   [Does Latinx Representation Matter for Latinx Student Retention in
    STEM?](https://journals-sagepub-com.ezproxy.csuci.edu/doi/full/10.1177/1538192718820532)

-   [Pathways of opportunity in
    STEM](https://www.proquest.com/docview/2830500411?accountid=7284&pq-origsite=primo&sourcetype=Scholarly%20Journals)

-   [Kinks in the STEM
    Pipeline](https://onlinelibrary-wiley-com.ezproxy.csuci.edu/doi/full/10.1111/ssm.12195?sid=vendor%3Adatabase)

-   [Navigating the Path to Persistence and
    Belonging](https://www.proquest.com/docview/3216947411?accountid=7284&parentSessionId=Hns4Y0dLPkO39%2BJg9MPXCqguu%2BT3eH0WSNhprh2nZa4%3D&pq-origsite=primo&sourcetype=Scholarly%20Journals)

-   [Application of logistic regression to predict the failure of
    students in subjects of a mathematics undergraduate
    course](https://go-gale-com.ezproxy.csuci.edu/ps/i.do?p=AONE&u=csuci&id=GALE%7CA727953830&v=2.1&it=r&aty=ip)

-   [Factors influencing university drop-out
    rates](https://www-sciencedirect-com.ezproxy.csuci.edu/science/article/pii/S0360131509000815)

-   [A comparison of artificial neural networks and the statistical
    methods in predicting MBA student's academic
    performance](https://www.proquest.com/docview/2571493278?accountid=7284&parentSessionId=TZbp4nzWFQxMHrqm%2F7aw79k75g3YIGz6Je8SlhO6OYU%3D&pq-origsite=primo&sourcetype=Scholarly%20Journals)

-   [Bayesian survival modelling of university
    outcomes](https://research-ebsco-com.ezproxy.csuci.edu/c/ppuxpx/viewer/pdf/xm3q3sjrxr?route=details)
...
ddata$Did_Graduate <- factor(ddata$Did_Graduate,
                                    levels = c(0, 1),
...
In regards to students' graduation rates, \[percentage\] (*n* =
\[1\]) graduated with a Bachelor's degree from the Department of
Computer Science (i.e. either "B.S. Computer Science," "B.S. Information
Technology," or "B.S. Mechatronics Engineering"), \[percentage\] (*n* =
\[number\]) graduated with Bachelor's degree from outside of the
Department of Computer Science, and \[percentage\] (*n* = \[number\])
did not graduate.
...
The sample consisted of 599 students, with 85.3% (n = 511) graduating with a major within the computer science department and 14.7% (n = 88) graduating with another major from a different department. Among the students, 84.8%  (n = 508) were males and 15.1% (n = 91) were females. Hispanic students made up 35.7% (n = 214) of the sample, while 64.7%  (n = 385) identified as non-Hispanic. There were 62.9% (n = 377) transfer students, and 71.1% (n = 426) were commuters. Full-time students made up 62.9% (n = 185), whereas 30.9% (n = 185) were part-time and 6.9% (n = 41) had heavy unit loads. 35.7% (n = 154)  of the students had no tutoring sessions, 33.6% (n = 201) used tutoring 1 to 5 times, 13.4% (n = 80) attended 6 to 10 sessions, and 27.4% (n = 164) attended tutoring 11 or more times.
...
exploration of students' Hispanic Status was important to the
researchers. The following chart showcases the makeup of Hispanic and
Non-Hispanic students in the Computer Science Department.
...
Channel Islands receives lots of transfer students due to the
institution's well-established relationships with local community
colleges and the institution's relatively low cost. This is supported by
the data we received below.
