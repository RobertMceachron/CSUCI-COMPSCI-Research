...
United States. This literature review will summarize the findings of a
few studies that address this topic more generally, as well as a few
additional studies that use logistic regression in their methods.
...
graduation from 1987 to 2018. Overall, the study found that all
demographic groups had lower levels of graduation compared to
enrollment. Graduation rates of white women declined sharply after 1990,
graduation rates of Black women sharply declined after 1995, graduation
rates of Asian women steadily declined after 1999, Hispanic women
consistently represented less than 2% of the population of computing
graduates, and there were many years where Native American women did not
graduate from computing programs at all. White men represented the
largest demographic of computing graduates (between 45.2% and 71.8% of
the total population of computing graduates), followed by Asian men at
around 10%. Graduation rates for Black men remained below 5% from 2005
onward, and graduation rates of Hispanic men were consistently less than
6%. There were many years where Native American men had no graduates
from computing degrees. Historical context analysis revealed more about
the responses to declines in minority enrollment and graduation, rather
than what actually caused those declines. There was much discussion
about the creation of professional organizations and conferences
dedicated to fostering a sense of belonging among minority women in
computing.

[Lord et
al.](https://ieeexplore-ieee-org.ezproxy.csuci.edu/document/6881755)
compared trajectories of students in electrical engineering (EE) and
computer engineering (CpE) programs by race/ethnicity and gender, also
using the MIDFIELD database. Although EE and CpE programs are not
necessarily "computing" programs, their curriculum is pretty
computing-focused, and they struggle with similar lack of diversity. The
population studied included students who matriculated directly into EE
and CpE, students who chose EE or CpE after completing a First-Year
Experience program, students who migrated into EE or CpE after being in
other majors, and transfer students. The study found that EE and CpE
programs are quite successful in attracting Black engineering students:
30% and 12% of Black men in engineering start in EE and CpE
respectively, and 22% and 12% of Black women in engineering start in EE
and CpE respectively. These programs, however, struggle to maintain
Black student participation through to graduation: 32% and 17% of Black
men who start in EE and CpE graduate, respectively, and 35% and 14% of
Black women who start in EE and CpE graduate, respectively. The authors
suggest that negative outcomes for Black students in EE and CpE are
likely due to socioeconomic differences, which "could masquerade as
racial differences." Hispanic women are another underserved population
in EE and CpE, according to the study. Hispanic women in engineering are
unlikely to start in either program and graduate at significantly lower
rates than Hispanic men in EE and CpE. To compare differences between
transfer and non-transfer students, the researchers used "major
stickiness" — the ratio of the number of students who graduate in a
major to the number of students who ever declared that major — finding
that transfer students across all racial/ethnic-gender groups were more
likely to persist to graduation than non-transfer students. Finally,
much of the discussion of this study was dedicated to postulating the
underlying reasons behind the low participation of women in EE and CpE
programs for all races/ethnicities. This was especially critical since
the study found that although men and women graduated at similar rates
across all races/ethnicities in EE, the six-year graduation rates for
women in CpE were noticeably lower across all races/ethnicities. The
authors argue that the low participation of women in EE and CpE programs
is likely a result of underlying cultural issues within the disciplines,
particularly the "distinctive hegemonic masculinity" found within EE
(and by extension CpE, since CpE originated from EE) leading women to
consistently underestimate their own capabilities in the disciplines.
...
the two groups, χ²(1, *n* = 1091) = 6.49, *p* \< 0.05.
...
sdata$Did_Graduate_Binary <- ifelse(sdata$Did_Graduate == sdata$Term_Code, 1, 0)

ddata <- select(sdata, Student, Is_Hispanic, Is_Transfer, Lived_On_Campus, Num_Tutoring_Visits, Gender_Binary, Did_Graduate_Binary)
...
Students who graduated with another major (*n* = 88) remained in the
computer science department for an average of 3.47 terms, whereas
students who graduated with a degree in CS/IT/EMEC (*n* = 511) had an
average of 7.39 terms. For students who graduated with another major,
transfer students (*n* = 26) remained in the computer science department
for an average of 2.23 terms, and non-transfer students (*n* = 62)
averaged 3.98 terms. An independent samples t-test was conducted to
compare the number of terms attended between non-transfer and transfer
students. The results indicated a significant difference in the mean
terms attended, *t*(69.99) = 4.998, *p* \< .001. Non-transfer students
attended significantly more terms on average compared to transfer
students. Among the students who graduated with a degree in CS/IT/EMEC,
transfer students (*n* = 351) averaged 6.59 terms, whereas non-transfer
students (*n* = 160) had an average of 9.13 terms. An independent
samples t-test was conducted to compare the number of terms attended
between non-transfer and transfer students. The results revealed a
significant difference in terms attended between the two groups,
*t*(280.88) = 14.09, *p* \< .001. Non-transfer students attended more
terms on average than transfer students.

A chi-squared test of independence was conducted to examine the
relationship between student status (Transfer vs. Non-Transfer) and
graduation outcome (Graduated with another major vs. graduated with
CS/IT/EMEC). Non-transfer students graduated with another major 62 times
and with CS/IT/EMEC 160 times, while transfer students graduated with
another major 26 times and with CS/IT/EMEC 351 times. The chi-square
analysis showed a statistically significant association between student
status and graduation outcome, χ²(1) = 47.65, *p* \< .001. Based on the
observed counts, transfer students were more likely to graduate with a
CS/IT/EMEC degree. In contrast, non-transfer students were relatively
more likely to graduate with another major.

#### Hispanic Status

Among the students who graduated with another major (*n* = 88), 35
identified as Hispanic and 53 were non-Hispanic. For students who
graduated with a CS/IT/EMEC degree (*n* = 511), 179 were Hispanic, and
332 were not Hispanic. A chi-squared test of independence indicated no
significant association between ethnicity (Hispanic vs. non-Hispanic)
and graduation outcome, χ²(1) = 0.54, *p* \> .05.

For students who graduated with a CS/IT/EMEC degree, Hispanic students
attended an average of 7.36 terms, while non-Hispanic students attended
an average of 7.40 terms. An independent samples t-test indicated no
significant difference in the number of terms attended between Hispanic
and non-Hispanic students, *t*(368.07) = 0.215, *p* \> .05. Among
students who graduated with another major, an independent samples t-test
indicated no significant difference in the number of terms attended
between Hispanic (*M* = 3.91) and non-Hispanic students (*M* = 3.17),
*t*(70.03) = -1.768, *p* \> .05.

#### Tutoring

For students who graduated with a CS/IT/EMEC degree, the distribution of
tutoring level was as follows: 125 students attended tutoring, 167
attended low tutoring (1 to 5 visits), 72 attended moderate tutoring (6
to 10 visits), and 147 attended high tutoring (11 or more). Among
students who graduated with another major, 29 students attended no
tutoring, 34 attended low tutoring, 8 attended moderate tutoring, and 17
attended high tutoring. A chi-squared test of independence indicated no
significant association between graduation type and tutoring level,
χ²(3) = 6.75, *p* \>.05. Additionally, a chi-squared test of
independence indicated no significant association between graduation
type and whether students attended tutoring (Yes Tutoring or No
Tutoring), with 386 CS/IT/EMEC graduates and 59 graduates with another
major attending tutoring, and 125 CS/IT/EMEC graduates and 29 graduates
with another major not attending, χ²(1) = 2.41, *p* \> .05.

#### Gender

For students who graduated with a CS/IT/EMEC degree, 72 identified as
female and 439 as male. According to institutional data, 67.8% of CSUCI
students in 2023 were female. A one-sample proportion test comparing the
proportion of female graduates within the computer science department to
the CSUCI female proportion revealed a statistically significant
difference, χ²(1) = 675.22, *p* \< .001.
...
The results of this study highlight several important patterns related
to graduation among students in the CSU Channel Islands Computer Science
Department. In Sample 1, which includes all students who entered the
department regardless of graduation outcome, males and females persisted
for a similar number of terms and graduated at similar rates. A total of
170 female students and 921 males were enrolled in the computer science
program. Among these students, 72 females and 439 males graduated with a
CS/IT/EMEC degree. However, representation among graduates revealed a
major disparity. A one-sample proportion test showed that the percentage
of female graduates (14.1%) was significantly lower than the
institutional female graduation rate of 67.8%, χ²(1) = 675.22, *p* \<
.001. The data suggest that underrepresentation of women may arise
primarily at entry into the major. Potential interventions to promote
female participation could include mentoring programs pairing female
students with current CS majors or alumnae and early outreach programs
targeting first-year female students to increase interest in the field.

In Sample 1, Hispanic students graduated at a significantly lower rate
(41.92%) than non-Hispanic students (50%), χ²(1, n = 1091) = 6.49, *p*
\< .001. Hispanic males and females showed lower graduation rates than
non-Hispanic students. However, Hispanic females graduate at the lowest
rate overall, which may indicate a combined effect of gender and
ethnicity. Despite these differences, Hispanic students attended a
similar number of terms as non-Hispanic students. In Sample 2,
graduation rates did not differ significantly by Hispanic status. These
findings suggest that disparities may emerge during the early academic
stages. Potential interventions to support Hispanic students' graduation
could include targeted support groups for this demographic within the
computer science department. Additionally, Hispanic students who are
starting the program may benefit from courses highlighting
accomplishments from those from racially diverse backgrounds.

Transfer status also played an important role, as transfer students had
higher odds of graduating, were more likely than non-transfer students
to complete a CS/IT/EMEC degree, and completed their degrees in fewer
terms on average than non-transfer students. Tutoring demonstrated a
strong relationship with graduation in Sample 1, with increased tutoring
visits associated with higher odds of completing a degree. However, in
Sample 2, tutoring was not a significant predictor of whether a student
graduated with or without a degree from the computer science department.
These patterns were further supported by logistic regression, which
showed that Hispanic identity, part-time status, housing, transfer
status, and tutoring significantly predicted graduation. Whereas in
Sample 2, the logistic regression analysis differences by gender and
Hispanic identity were no longer significant. This suggests that
demographic inequities may emerge earlier in a student’s academic
career, whereas transfer students and tutoring remain consistent
predictors of degree completion. Computer science students may benefit
from mandatory tutoring sessions or workshops specifically designed to
promote proficiency in academic milestones (e.g., coding in R or Python,
mathematical reasoning behind statistical approaches, etc).

Due to the type and amount of data collected, the present research had
numerous limitations. First, it was unclear why students did not
graduate. Students’ reasons for dropping out were not collected, and we
were subsequently unable to determine whether they transferred to
another institution or simply took a break from their education. Second,
the historical impact of COVID-19 could not be fully analyzed due to
students who began their degree during or after this time still being
enrolled. It is theorized that COVID-19 likely had a significant impact
on graduation rates, and due to half of our data being collected after
this historical event, it could explain a lot regarding graduation.
Third, the extreme outliers in variables such as tutoring visits and
unit load required binning, as these students did not represent the
overall population. This likely resulted in a loss of information, which
could have helped explain more of the variance in graduation. Lastly,
variables such as GPA, classes taken each semester, and income level
could have helped explain graduation. The variables were not included
due to the sensitive nature of institutional data, but institutional
researchers could further examine their effects. The limitations
mentioned above limit the explanatory power and generalizability of our
analyses, but future research can account for some of these variables.

Future research should compare graduation rates across departments to
determine whether the significant predictors are specific to the
Computer Science Department. Furthermore, examining parental and student
income status could provide valuable insight into why students drop out.
Statistical analyses such as Discrete-time Survival Analysis could help
explain when students drop out of the program, as the Cox Proportional
Hazards model run in the current research did not meet its assumptions.
Lastly, Qualitative interviews could prove beneficial for identifying
the stressors students have personally identified in the Computer
Science Department and for validating or expanding the variables of
interest.
